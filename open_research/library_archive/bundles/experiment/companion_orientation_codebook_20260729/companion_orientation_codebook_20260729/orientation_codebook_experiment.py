...
PROTOCOL='priority6-coherent-orientation-codebook-v1'
EPS=1e-30
...
def main():
    ...
    manifest={'protocol':PROTOCOL,'base_ids':seeds,'variants':a.variants,'orientation_seeds':ORIENTATION_SEEDS[:a.orientations],
              ...
              'split_by_base':{'development':seeds[:a.bases//2], 'calibration':seeds[a.bases//2:a.bases*3//4], 'test':seeds[a.bases*3//4:]}}
