...
| Signed stability | Infinite kernel | Arbitrary consolidated signed measure | Bounded negative mass | Static | Linear | Proved but weak |
...
T22 uses exact rational coefficients, directed interval arithmetic, deterministic interval chunks, exact multiplicities, a directed kernel-mean enclosure and a hash manifest. T16 adds exact integer recurrences, interval sixth-derivative bounds and an interval linear-system certificate. The results are computer-assisted, not proof-assistant formalized.
...
- The T16 sixth-derivative/Hermite step awaits independent second-stack replication.
