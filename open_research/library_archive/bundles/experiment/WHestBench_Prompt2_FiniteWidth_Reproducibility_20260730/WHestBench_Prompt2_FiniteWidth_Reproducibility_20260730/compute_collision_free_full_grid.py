...
def one(t):
 ...
 z=energy(r,k,None)
 p=f'/mnt/data/cf_full_tensor{r}_degree_{k}.json'
...
if __name__=='__main__':
 ...
 ts=[(r,k) for r in range(a.rmin,a.rmax+1) for k in range(a.kmax+1) if not os.path.exists(f'/mnt/data/cf_full_tensor{r}_degree_{k}.json')]
