...
| Certificate replay | replayable | The arXiv ancillary proof archive is published byte-identical in [`../theory/proof_archive/`](../theory/proof_archive/). Five checks replay in ~40 s and pass in CI. This is exact replay downstream of stored interval inputs, not independent reconstruction. |
